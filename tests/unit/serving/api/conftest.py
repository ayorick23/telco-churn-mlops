"""Payload compartido por los tests de serving/api: un cliente crudo válido
con los 37 campos que `CustomerFeatures` espera (nombres de columna
originales, con espacios — mismo formato que manda un caller real de la
API)."""
